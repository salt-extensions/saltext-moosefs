...
src_dir = repo_path / "src" / " saltext" / "salt-moosefs"
...
for path in Path(__file__).parent.parent.joinpath("src/saltext/salt-moosefs/").glob("*/*.py"):
